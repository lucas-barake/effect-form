...
const TextInput: FormSolid.FieldComponent<string, { readonly testId?: string }> = (props) => (
  <div>
    <input
      type="text"
      ...
      data-testid={props.props.testId ?? "text-input"}
    />
    <Show when={Option.isSome(props.field.error)}>
      <span data-testid={`${props.props.testId ?? "text-input"}-error`}>{Option.getOrNull(props.field.error)}</span>
    </Show>
  </div>
)

const NameInput: FormSolid.FieldComponent<string> = (props) => (
  <TextInput field={props.field} props={{ testId: "name-input" }} />
)

const AgeInput: FormSolid.FieldComponent<string> = (props) => (
  <TextInput field={props.field} props={{ testId: "age-input" }} />
)
